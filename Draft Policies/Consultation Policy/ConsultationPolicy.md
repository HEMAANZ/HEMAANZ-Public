...
## Definitions
The term "policy" is used to refer to any bylaw, code of conduct, recommendation, or similar published document held to be current by the **Society**. 
It explicitly excludes the **Constitution**. 

The **Committee** includes any **Subcommittee** established by the executive **Committee** that is acting within their purview. 
...
4. After a period of not less than 20 business days, the **Committee** must meet to collate feedback and suggestions. If there is any opposition to the proposal, the **Committee** must address concerns and suggestions where reasonable by modifying the proposal, with the goal of consensus. The modified proposal must then be communicated to all **Member**s and feedback sought as per step 3.
